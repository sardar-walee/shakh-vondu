            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-xs font-black text-white">ئەپدەیتی نوێی شاخی</span>
                  <span className="text-[10px] font-latin font-bold bg-orange-500 text-white px-2 py-0.5 rounded-md">
                    {appVersion.version}
                  </span>
                </div>
                <p className="text-[11px] text-slate-300 line-clamp-1 mt-0.5">
                  {appVersion.title || 'نوێکاری و تایبەتمەندی نوێ بەردەستە'}
                </p>
              </div>
            </div>
              ...
              <div className="relative z-10 flex items-start justify-between">
                <div className="space-y-1.5">
                  <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-3 py-1 rounded-full text-xs font-black">
                    ...
                    <span>ئەپدەیت و وەشانی فەرمی</span>
                    <span className="font-latin bg-white text-orange-600 px-2 py-0.2 rounded-md font-bold text-[11px]">
                      {appVersion.version}
                    </span>
                  </div>
                  <h2 className="text-xl font-black text-white mt-1">
                    {appVersion.title || 'وەشانی نوێی شاخی بەردەستە!'}
                  </h2>
                  <p className="text-xs text-white/90">
                    بەرواری دەرچوون: {appVersion.releaseDate || 'ئەمڕۆ'}
                  </p>
                </div>
            ...
            <div className="p-6 space-y-5">
              ...
              <div className="space-y-2.5">
                <h4 className="text-xs font-black text-slate-700 dark:text-slate-300 flex items-center gap-2">
                  ...
                  <span>تایبەتمەندی و گۆڕانکارییە نوێیەکان لەم وەشانەدا:</span>
                </h4>

                <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                  {(appVersion.changelog && appVersion.changelog.length > 0 ? appVersion.changelog : [
                    'زیادکردنی بەڕێوەبردنی تەواوی کاپتنانی گەیاندن لە داشبۆردی سەرجەم ڕۆڵەکان',
                    'پشتیوانی زانیارییە وردەکانی کاپتن (جۆری ئامراز، تابلۆ، ژمارە، چاودێری ئەرک)',
                    'سیستەمی نوێی ئاگاداری ڕاستەوخۆ بۆ بەردەستبوونی هەر ئەپدەیتێک',
                    'چاککردنی فلتەری پۆلە لاوەکییەکان بۆ هەموو بەشەکان'
                  ]).map((item, idx) => (
                    <div
                      key={idx}
              ...
              {appVersion.isMandatory && (
                <div className="p-3 bg-amber-50 dark:bg-amber-950/40 border border-amber-300 dark:border-amber-800 rounded-xl flex items-center gap-2.5 text-xs text-amber-900 dark:text-amber-200 font-bold">
                  ...
                  <span>ئەم ئەپدەیتە ناچارییە بۆ پاراستنی ئەمنییەت و دروستی کارکردنی ئەپ.</span>
                </div>
              )}
                ...
                >
                  {isUpdating ? (
                    <>
                      ...
                      <span>خەریکی نوێکردنەوە و ڕیفرێشە...</span>
                    </>
                  ) : updateSuccess ? (
                    <>
                      <CheckCircle2 className="w-4 h-4 text-emerald-300" />
                      <span>بە سەرکەوتوویی نوێکرایەوە!</span>
                    </>
                  ) : (
                    <>
                      <RefreshCw className="w-4 h-4" />
                      <span>نوێکردنەوە و ڕیفرێشی ئەپ دەستبەجێ</span>
                    </>
                  )}
                </button>
